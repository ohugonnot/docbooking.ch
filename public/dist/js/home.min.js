! function(t, e) {
    ...
    return function(t) {
        ...
        function i() {
            ...
            }, t.AST = o.default, t.Compiler = c.Compiler, t.JavaScriptCompiler = u.default, t.Parser = a.parser, t.parse = a.parse, t.parseWithoutProcessing = a.parseWithoutProcessing, t
        }
        var r = n(1).default;
        e.__esModule = !0;
        var s = r(n(2)),
            ...
            p = s.default.create,
            f = i();
        f.create = i, h.default(f), f.Visitor = l.default, f.default = f, e.default = f, t.exports = e.default
    }, function(t, e) {
        "use strict";
        ...
        function i() {
            ...
            return u.extend(t, o), t.SafeString = a.default, t.Exception = c.default, t.Utils = u, t.escapeExpression = u.escapeExpression, t.VM = l, t.template = function(e) {
        ...
        function i(t, e, n) {
            this.helpers = t || {}, this.partials = e || {}, this.decorators = n || {}, a.registerDefaultHelpers(this), c.registerDefaultDecorators(this)
        }
        var r = n(1).default;
        ...
        i.prototype = {
            ...
            registerPartial: function(t, e) {
                if (s.toString.call(t) === h) s.extend(this.partials, t);
                else {
        ...
        var p = u.default.log;
        e.log = p, e.createFrame = s.createFrame, e.logger = u.default
    }, function(t, e) {
        "use strict";
        ...
        function i(t, e) {
            var n = e && e.loc,
                ...
                c = void 0,
                u = void 0;
            n && (o = n.start.line, a = n.end.line, c = n.start.column, u = n.end.column, t += " - " + o + ":" + c);
            for (var l = Error.prototype.constructor.call(this, t), h = 0; h < s.length; h++) this[s[h]] = l[s[h]];
            Error.captureStackTrace && Error.captureStackTrace(this, i);
            try {
                n && (this.lineNumber = o, this.endLineNumber = a, r ? (Object.defineProperty(this, "column", {
                    value: c,
                    enumerable: !0
        ...
        e.__esModule = !0, e.registerDefaultHelpers = function(t) {
            r.default(t), s.default(t), o.default(t), a.default(t), c.default(t), u.default(t), l.default(t)
        ...
        (function(i) {
            ...
            e.default = function(t) {
                t.registerHelper("each", function(t, e) {
                    function n(e, n, i) {
                        h && (h.key = e, h.index = n, h.first = 0 === n, h.last = !!i, p && (h.contextPath = p + e)), l += s(t[e], {
                            data: h,
                    ...
                    var s = e.fn,
                        ...
                        h = void 0,
                        p = void 0;
                    if (e.data && e.ids && (p = o.appendContextPath(e.data.contextPath, e.ids[0]) + "."), o.isFunction(t) && (t = t.call(this)), e.data && (h = o.createFrame(e.data)), t && "object" == typeof t)
                        if (o.isArray(t))
                            for (var f = t.length; u < f; u++) u in t && n(u, u, u === t.length - 1);
                        else if (i.Symbol && t[i.Symbol.iterator]) {
                        for (var d = [], m = t[i.Symbol.iterator](), g = m.next(); !g.done; g = m.next()) d.push(g.value);
                        for (f = (t = d).length; u < f; u++) n(u, u, u === t.length - 1)
                    } else ! function() {
                        var e = void 0;
                        r(t).forEach(function(t) {
                            void 0 !== e && n(e, u - 1), e = t, u++
                        }), void 0 !== e && n(e, u - 1, !0)
                    }();
                    return 0 === u && (l = c(this)), l
                })
            }, t.exports = e.default
        }).call(e, function() {
            return this
        ...
        n(15), t.exports = n(21).Object.keys
    }, function(t, e, n) {
        var i = n(16);
        ...
        var i = n(20),
            ...
            a = function(t, e, n) {
                var c, u, l, h = t & a.F,
                    ...
                    v = p ? r : r[e] || (r[e] = {}),
                    y = p ? i : f ? i[e] : (i[e] || {})[o];
                for (c in p && (n = e), n)(u = !h && y && c in y) && c in v || (l = u ? y[c] : n[c], v[c] = p && "function" != typeof y[c] ? n[c] : m && u ? s(l, i) : g && y[c] == l ? function(t) {
                    var e = function(e) {
                        return this instanceof t ? new t(e) : t(e)
                    };
                    return e[o] = t[o], e
                }(l) : d && "function" == typeof l ? s(Function.call, l) : l, d && ((v[o] || (v[o] = {}))[c] = l))
            };
        ...
        e.__esModule = !0, e.createNewLookupObject = function() {
            ...
            return r.extend.apply(void 0, [i(null)].concat(e))
        };
        var r = n(5)
    }, function(t, e) {
        "use strict";
        ...
        function i(t, e, n, i, r, o, a) {
            ...
            return (c = s(n, c, t, a, i, o)).program = e, c.depth = a ? a.length : 0, c.blockParams = r || 0, c
        }
        ...
        function s(t, e, n, i, r, s) {
            if (t.decorator) {
                var o = {};
                e = t.decorator(e, o, n, i && i[0], r, s, i), l.extend(e, o)
            }
            return e
        }
        var o = n(39).default,
        ...
        e.__esModule = !0, e.checkRevision = function(t) {
            ...
            if (!(e >= p.LAST_COMPATIBLE_COMPILER_REVISION && e <= p.COMPILER_REVISION)) {
                if (e < p.LAST_COMPATIBLE_COMPILER_REVISION) {
            ...
            function n(e) {
                function i(e) {
                    return "" + t.main(c, e, c.helpers, c.partials, o, u, a)
                }
                var r = arguments.length <= 1 || void 0 === arguments[1] ? {} : arguments[1],
                    o = r.data;
                n._setup(r), !r.partial && t.useData && (o = function(t, e) {
                    return e && "root" in e || ((e = e ? p.createFrame(e) : {}).root = t), e
                }(e, o));
                var a = void 0,
                    u = t.useBlockParams ? [] : void 0;
                return t.useDepths && (a = r.depths ? e != r.depths[0] ? [e].concat(r.depths) : r.depths : [e]), (i = s(t.main, i, c, r.depths || [], o, u))(e, r)
            }
            ...
            var r = t.compiler && 7 === t.compiler[0],
                c = {
                    ...
                    lookupProperty: function(t, e) {
                        var n = t[e];
                        return null == n ? n : Object.prototype.hasOwnProperty.call(t, e) ? n : m.resultIsAllowed(n, c.protoAccessControl, e) ? n : void 0
                    },
                    lookup: function(t, e) {
                        for (var n = t.length, i = 0; i < n; i++)
                            if (null != (t[i] && c.lookupProperty(t[i], e))) return t[i][e]
                    },
                    lambda: function(t, e) {
                    ...
                    invokePartial: function(n, i, r) {
                        r.hash && (i = l.extend({}, i, r.hash), r.ids && (r.ids[0] = !0)), n = e.VM.resolvePartial.call(this, n, i, r);
                        var s = l.extend({}, r, {
                                hooks: this.hooks,
                                protoAccessControl: this.protoAccessControl
                            }),
                            o = e.VM.invokePartial.call(this, n, i, s);
                        if (null == o && e.compile && (r.partials[r.name] = e.compile(n, t.compilerOptions, e), o = r.partials[r.name](i, s)), null != o) {
                            if (r.indent) {
                                for (var a = o.split("\n"), c = 0, u = a.length; c < u && (a[c] || c + 1 !== u); c++) a[c] = r.indent + a[c];
                                o = a.join("\n")
                            }
                            return o
                        }
            ...
            return n.isTop = !0, n._setup = function(n) {
                if (n.partial) c.protoAccessControl = n.protoAccessControl, c.helpers = n.helpers, c.partials = n.partials, c.decorators = n.decorators, c.hooks = n.hooks;
                else {
                    var i = l.extend({}, e.helpers, n.helpers);
                    (function(t, e) {
                        a(t).forEach(function(n) {
                            var i = t[n];
                            t[n] = function(t, e) {
                                var n = e.lookupProperty;
                                return d.wrapHelper(t, function(t) {
                                    return l.extend({
                                        lookupProperty: n
                                    }, t)
                                })
                    ...
                    })(i, c), c.helpers = i, t.usePartial && (c.partials = c.mergeIfNeeded(n.partials, e.partials)), (t.usePartial || t.useDecorators) && (c.decorators = l.extend({}, e.decorators, n.decorators)), c.hooks = {}, c.protoAccessControl = m.createProtoAccessControl(n);
                    var s = n.allowCallsToHelperMissing || r;
                    f.moveHelperToHooks(c, "helperMissing", s), f.moveHelperToHooks(c, "blockHelperMissing", s)
                }
            }, n._child = function(e, n, r, s) {
                if (t.useBlockParams && !r) throw new h.default("must pass block params");
                if (t.useDepths && !s) throw new h.default("must pass parent depths");
                return i(c, e, t[e], n, 0, r, s)
            }, n
            ...
            if (n.fn && n.fn !== r && function() {
                    ...
                    s = n.data["partial-block"] = function(e) {
                        ...
                        return n.data = p.createFrame(n.data), n.data["partial-block"] = i, t(e, n)
                    }, t.partials && (n.partials = l.extend({}, n.partials, t.partials))
                }(), void 0 === t && s && (t = s), void 0 === t) throw new h.default("The partial " + n.name + " could not be found");
        ...
        n(41), t.exports = n(21).Object.seal
    }, function(t, e, n) {
        var i = n(42);
        ...
        function i(t, e) {
            return "Program" === t.type ? t : (o.default.yy = l, l.locInfo = function(t) {
                return new l.SourceLocation(e && e.srcName, t)
            }, o.default.parse(t))
        }
        var r = n(1).default,
            s = n(3).default;
        e.__esModule = !0, e.parseWithoutProcessing = i, e.parse = function(t, e) {
            var n = i(t, e);
            return new a.default(e).accept(n)
        };
        var o = r(n(47)),
            a = r(n(48)),
            c = s(n(50)),
        ...
        var n = function() {
            ...
            var e = {
                    ...
                    performAction: function(t, e, n, i, r, s, o) {
                        ...
                        switch (r) {
                            ...
                            case 18:
                                ...
                                break;
                            case 19:
                                var c = i.prepareBlock(s[a - 2], s[a - 1], s[a], s[a], !1, this._$),
                                    u = i.prepareProgram([c], s[a - 1].loc);
                                u.chained = !0, this.$ = {
                                    strip: s[a - 2].strip,
                                    program: u,
                                    chain: !0
                    ...
                    parse: function(t) {
                        ...
                        for (var f, d, m, g, v, y, _, b, k, S = {};;) {
                            if (m = i[i.length - 1], this.defaultActions[m] ? g = this.defaultActions[m] : (null != f || (f = e()), g = o[m] && o[m][f]), void 0 === g || !g.length || !g[0]) {
                                var x = "";
                                if (!l) {
                                    for (y in k = [], o[m]) this.terminals_[y] && y > 2 && k.push("'" + this.terminals_[y] + "'");
                                    x = this.lexer.showPosition ? "Parse error on line " + (c + 1) + ":\n" + this.lexer.showPosition() + "\nExpecting " + k.join(", ") + ", got '" + (this.terminals_[f] || f) + "'" : "Parse error on line " + (c + 1) + ": Unexpected " + (1 == f ? "end of input" : "'" + (this.terminals_[f] || f) + "'"), this.parseError(x, {
                            ...
                            switch (g[0]) {
                                case 1:
                                    i.push(f), r.push(this.lexer.yytext), s.push(this.lexer.yylloc), i.push(g[1]), f = null, d ? (f = d, d = null) : (u = this.lexer.yyleng, a = this.lexer.yytext, c = this.lexer.yylineno, h = this.lexer.yylloc, l > 0 && l--);
                                    break;
                                case 2:
                                    if (_ = this.productions_[g[1]][1], S.$ = r[r.length - _], S._$ = {
                                            first_line: s[s.length - (_ || 1)].first_line,
                                            last_line: s[s.length - 1].last_line,
                                            first_column: s[s.length - (_ || 1)].first_column,
                                            last_column: s[s.length - 1].last_column
                                        }, p && (S._$.range = [s[s.length - (_ || 1)].range[0], s[s.length - 1].range[1]]), void 0 !== (v = this.performAction.call(S, a, u, c, this.yy, g[1], r, s))) return v;
                                    _ && (i = i.slice(0, -1 * _ * 2), r = r.slice(0, -1 * _), s = s.slice(0, -1 * _)), i.push(this.productions_[g[1]][0]), r.push(S.$), s.push(S._$), b = o[i[i.length - 2]][i[i.length - 1]], i.push(b);
                                    break;
                                case 3:
                                    return !0
                            }
        ...
        i.prototype = new u.default, i.prototype.Program = function(t) {
            var e = !this.options.ignoreStandalone,
                n = !this.isRootSeen;
            this.isRootSeen = !0;
            for (var i = t.body, c = 0, u = i.length; c < u; c++) {
                var l = i[c],
                    h = this.accept(l);
                if (h) {
                    var p = r(i, c, n),
                    ...
                    h.close && o(i, c, !0), h.open && a(i, c, !0), e && g && (o(i, c), a(i, c) && "PartialStatement" === l.type && (l.indent = /([ \t]+$)/.exec(i[c - 1].original)[1])), e && d && (o((l.program || l.inverse).body), a(i, c)), e && m && (o(i, c), a((l.inverse || l.program).body))
                }
            }
            return t
            ...
            var e = t.program || t.inverse,
                ...
                c = n;
            if (n && n.chained)
                for (i = n.body[0].program; c.chained;) c = c.body[c.body.length - 1].program;
            var u = {
            ...
            if (t.openStrip.close && o(e.body, null, !0), n) {
                ...
                l.open && a(e.body, null, !0), l.close && o(i.body, null, !0), t.closeStrip.open && a(c.body, null, !0), !this.options.ignoreStandalone && r(e.body) && s(i.body) && (a(e.body), o(i.body))
        ...
        e.__esModule = !0, e.SourceLocation = function(t, e) {
            ...
            n = this.locInfo(n);
            for (var i = t ? "@" : "", r = [], o = 0, a = 0, c = e.length; a < c; a++) {
                var u = e[a].part,
                    l = e[a].original !== u;
                if (i += (e[a].separator || "") + u, l || ".." !== u && "." !== u && "this" !== u) r.push(u);
                else {
            ...
            var u = void 0,
                l = void 0;
            if (n) {
                if (c) throw new s.default("Unexpected inverse block on decorator", n);
        ...
        i.prototype = {
            ...
            compile: function(t, e) {
                return this.sourceNode = [], this.opcodes = [], this.children = [], this.options = e, this.stringParams = e.stringParams, this.trackIds = e.trackIds, e.blockParams = e.blockParams || [], e.knownHelpers = u.extend(o(null), {
                    helperMissing: !0,
            ...
            helperSexpr: function(t, e, n) {
                ...
                if (this.options.knownHelpers[s]) this.opcode("invokeKnownHelper", i.length, s);
                    ...
                    r.strict = !0, r.falsy = !0, this.accept(r), this.opcode("invokeHelper", i.length, r.original, l.default.helpers.simpleId(r))
                }
            },
            PathExpression: function(t) {
                this.addDepth(t.depth), this.opcode("getContext", t.depth);
                var e = t.parts[0],
                    n = l.default.helpers.scopedId(t),
            ...
            classifySexpr: function(t) {
                var e = l.default.helpers.simpleId(t.path),
                    ...
                    i = !n && l.default.helpers.helperExpression(t),
                    r = !n && (i || e);
                if (r && !i) {
            ...
            pushParam: function(t) {
                ...
                if (this.stringParams) e.replace && (e = e.replace(/^(\.?\.\/)*/g, "").replace(/\//g, ".")), t.depth && this.addDepth(t.depth), this.opcode("getContext", t.depth || 0), this.opcode("pushStringParam", e, t.type), "SubExpression" === t.type && this.accept(t);
                    ...
                    if (this.trackIds) {
                        var n = void 0;
                        if (!t.parts || l.default.helpers.scopedId(t) || t.depth || (n = this.blockParamIndex(t.parts[0])), n) {
        ...
        r.prototype = {
                ...
                compile: function(t, e, n, i) {
                    ...
                    var r = t.opcodes,
                        ...
                        a = void 0,
                        u = void 0;
                    for (a = 0, u = r.length; a < u; a++) s = r[a], this.source.currentLocation = s.loc, o = o || s.loc, this[s.opcode].apply(this, s.args);
                    ...
                    var p = this.context,
                        f = p.programs,
                        d = p.decorators;
                    for (a = 0, u = f.length; a < u; a++) f[a] && (h[a] = f[a], d[a] && (h[a + "_d"] = d[a], h.useDecorators = !0));
                ...
                resolvePath: function(t, e, n, i, r) {
                    ...
                    if (this.options.strict || this.options.assumeObjects) this.push(function(t, e, n, i) {
                        ...
                        return t ? [e.aliasable("container.strict"), "(", r, ", ", e.quotedString(n[s]), ", ", JSON.stringify(e.source.currentLocation), " )"] : r
                ...
                invokeHelper: function(t, e, n) {
                    var i = this.popStack(),
                        ...
                        s = [];
                    n && s.push(r.name), s.push(i), this.options.strict || s.push(this.aliasable("container.hooks.helperMissing"));
                ...
                replaceStack: function(t) {
                    ...
                    var u = t.call(this, n);
                    s || this.popStack(), r && this.stackSlot--, this.push(e.concat(u, ")"))
                },
                incrStack: function() {
                ...
                setupParams: function(t, e, n) {
                    ...
                    var u = this.popStack(),
                        l = this.popStack();
                    (l || u) && (i.fn = l || "container.noop", i.inverse = u || "container.noop");
                    for (var h = e; h--;) c = this.popStack(), n[h] = c, this.trackIds && (o[h] = this.popStack()), this.stringParams && (s[h] = this.popStack(), r[h] = this.popStack());
        ...
        a || ((a = function(t, e, n, i) {
            ...
            objectLiteral: function(t) {
                ...
                s(t).forEach(function(r) {
                    var s = i(t[r], e);
                    "undefined" !== s && n.push([e.quotedString(r), ":", s])
                });
...
function(t, e) {
    ...
    var e = function() {
            ...
            return {
                ...
                debounce: function(t, e, n) {
                    ...
                    return function() {
                        ...
                        }, o = n && !i, clearTimeout(i), i = setTimeout(s, e), o && (r = t.apply(a, c)), r
                    }
                },
                throttle: function(t, e) {
                    ...
                    return o = 0, a = function() {
                        ...
                        function() {
                            var c = new Date,
                                u = e - (c - o);
                            return n = this, i = arguments, u <= 0 ? (clearTimeout(r), r = null, o = c, s = t.apply(n, i)) : r || (r = setTimeout(a, u)), s
                        }
                },
        ...
        s = function() {
            ...
            function a(t) {
                t = t || {}, this.cancelled = !1, this.lastReq = null, this._send = t.transport, this._get = t.limiter ? t.limiter(this._get) : this._get, this._cache = !1 === t.cache ? new i(0) : o
            }
            return a.setMaxPendingRequests = function(t) {
                ...
                _get: function(t, e) {
                    ...
                    i = this._fingerprint(t), this.cancelled || i !== this.lastReq || ((o = r[i]) ? o.done(c).fail(u) : n < s ? (n++, r[i] = this._send(t).done(c).fail(u).always(function() {
                        n--, delete r[i], a.onDeckRequestArgs && (a._get.apply(a, a.onDeckRequestArgs), a.onDeckRequestArgs = null)
            ...
            return e.mixin(r.prototype, {
                ...
                add: function(t) {
                    ...
                    t = e.isArray(t) ? t : [t], e.each(t, function(t) {
                        var a, c;
                        r.datums[a = r.identify(t)] = t, c = s(r.datumTokenizer(t)), e.each(c, function(t) {
                            var e, s, c;
                            for (e = r.trie, s = t.split(""); c = s.shift();)(e = e[n][c] || (e[n][c] = o()))[i].push(a)
                        })
                    })
                },
                get: function(t) {
                ...
                search: function(t) {
                    ...
                    return r = s(this.queryTokenizer(t)), e.each(r, function(t) {
                        ...
                        for (e = a.trie, r = t.split(""); e && (s = r.shift());) e = e[n][s];
                        if (!e || 0 !== r.length) return o = [], !1;
                        c = e[i].slice(0), o = o ? function(t, e) {
                            var n = 0,
                                i = 0,
                                r = [];
                            t = t.sort(), e = e.sort();
        ...
        u = function() {
            ...
            return function(i) {
                ...
                return r = {
                    ...
                    prefetch: null,
                    remote: null
                }, !(i = e.mixin(r, i || {})).datumTokenizer && t.error("datumTokenizer is required"), !i.queryTokenizer && t.error("queryTokenizer is required"), s = i.sorter, i.sorter = s ? function(t) {
                    return t.sort(s)
                } : e.identity, i.local = e.isFunction(i.local) ? i.local() : i.local, i.prefetch = function(i) {
                    var r;
                    return i ? (r = {
                        url: null,
                        ttl: 864e5,
                        ...
                        url: i
                    } : i, !(i = e.mixin(r, i)).url && t.error("prefetch requires url to be set"), i.transform = i.filter || i.transform, i.cacheKey = i.cacheKey || i.url, i.thumbprint = "0.11.1" + i.thumbprint, i.transport = i.transport ? n(i.transport) : t.ajax, i) : null
                    ...
                    if (i) return r = {
                        ...
                        url: i
                    } : i, !(i = e.mixin(r, i)).url && t.error("remote requires url to be set"), i.transform = i.filter || i.transform, i.prepare = function(t) {
                        var e, n, i;
                        return e = t.prepare, n = t.replace, i = t.wildcard, e || (n ? function(t, e) {
                    ...
                    }(i), i.transport = i.transport ? n(i.transport) : t.ajax, delete i.replace, delete i.wildcard, delete i.rateLimitBy, delete i.rateLimitWait, i
                }(i.remote), i
            };
    ...
    return function() {
        ...
        function r(t) {
            t = u(t), this.sorter = t.sorter, this.identify = t.identify, this.sufficient = t.sufficient, this.local = t.local, this.remote = t.remote ? new c(t.remote) : null, this.prefetch = t.prefetch ? new a(t.prefetch) : null, this.index = new o({
                identify: this.identify,
                datumTokenizer: t.datumTokenizer,
                queryTokenizer: t.queryTokenizer
            }), !1 !== t.initialize && this.initialize()
        }
        return i = window && window.Bloodhound, r.noConflict = function() {
...
function(t, e) {
    ...
    var e = function() {
            ...
            return {
                ...
                trigger: function(n) {
                    ...
                    for (n = n.split(t), o = [].slice.call(arguments, 1);
                        (r = n.shift()) && (s = this._callbacks[r]);) a = i(s.sync, this, [r].concat(o)), c = i(s.async, this, [r].concat(o)), a() && e(c);
                    return this
                }
            };
            ...
            return n = {
                ...
                _getSuggestionsFragment: function(i, r) {
                    ...
                    return o = document.createDocumentFragment(), e.each(r, function(e) {
                        var r, s;
                        s = a._injectQuery(i, e), r = t(a.templates.suggestion(s)).data(n.obj, e).data(n.val, a.displayFn(e)).addClass(a.classes.suggestion + " " + a.classes.selectable), o.appendChild(r[0])
                    }), this.highlight && s({
        ...
        u = function() {
            ...
            return e.mixin(n.prototype, c.prototype, {
                open: function() {
        ...
        l = function() {
            ...
            function n(n, r) {
                var s, o, a, c, u, l, h, p, f, d, m;
                (n = n || {}).input || t.error("missing input"), n.menu || t.error("missing menu"), n.eventBus || t.error("missing event bus"), r.mixin(this), this.eventBus = n.eventBus, this.minLength = e.isNumber(n.minLength) ? n.minLength : 1, this.input = n.input, this.menu = n.menu, this.enabled = !0, this.active = !1, this.input.hasFocus() && this.activate(), this.dir = this.input.getLangDir(), this._hacks(), this.menu.bind().onSync("selectableClicked", this._onSelectableClicked, this).onSync("asyncRequested", this._onAsyncRequested, this).onSync("asyncCanceled", this._onAsyncCanceled, this).onSync("asyncReceived", this._onAsyncReceived, this).onSync("datasetRendered", this._onDatasetRendered, this).onSync("datasetCleared", this._onDatasetCleared, this), s = i(this, "activate", "open", "_onFocused"), o = i(this, "deactivate", "_onBlurred"), a = i(this, "isActive", "isOpen", "_onEnterKeyed"), c = i(this, "isActive", "isOpen", "_onTabKeyed"), u = i(this, "isActive", "_onEscKeyed"), l = i(this, "isActive", "open", "_onUpKeyed"), h = i(this, "isActive", "open", "_onDownKeyed"), p = i(this, "isActive", "isOpen", "_onLeftKeyed"), f = i(this, "isActive", "isOpen", "_onRightKeyed"), d = i(this, "_openIfActive", "_onQueryChanged"), m = i(this, "_openIfActive", "_onWhitespaceChanged"), this.input.bind().onSync("focused", s, this).onSync("blurred", o, this).onSync("enterKeyed", a, this).onSync("tabKeyed", c, this).onSync("escKeyed", u, this).onSync("upKeyed", l, this).onSync("downKeyed", h, this).onSync("leftKeyed", p, this).onSync("rightKeyed", f, this).onSync("queryChanged", d, this).onSync("whitespaceChanged", m, this).onSync("langDirChanged", this._onLangDirChanged, this)
            }
            return e.mixin(n.prototype, {
                _hacks: function() {
                    var n, i;
                ...
                _updateHint: function() {
                    var t, n, i, r, s, a;
                    t = this.menu.getTopSelectable(), n = this.menu.getSelectableData(t), i = this.input.getInputValue(), !n || e.isBlankString(i) || this.input.hasOverflow() ? this.input.clearHint() : (r = o.normalizeQuery(i), s = e.escapeRegExChars(r), (a = new RegExp("^(?:" + s + ")(.+$)", "i").exec(n.val)) && this.input.setHint(i + a[1]))
                },
                isEnabled: function() {
                    return this.enabled
                },
    ...
    ! function() {
        ...
        r = t.fn.typeahead, s = {
            ...
            initialize: function(r, a) {
                var h;
                return a = e.isArray(a) ? a : [].slice.call(arguments, 1), h = n((r = r || {}).classNames), this.each(function() {
                    var n, f, d, m, g, v, y, _, b, k, S;
                    e.each(a, function(t) {
                        t.highlight = !!r.highlight
                    }), n = t(this), f = t(h.html.wrapper), d = p(r.hint), m = p(r.menu), g = !1 !== r.hint && !d, v = !1 !== r.menu && !m, g && (d = function(t, e) {
                        ...
                        var n
                    }(n, h)), v && (m = t(h.html.menu).css(h.css.menu)), d && d.val(""), n = function(t, e) {
                        t.data(s.attrs, {
                            dir: t.attr("dir"),
                        ...
                        return t
                    }(n, h), (g || v) && (f.css(h.css.wrapper), n.css(g ? h.css.input : h.css.inputWithNoHint), n.wrap(f).parent().prepend(g ? d : null).append(v ? m : null)), S = v ? u : c, y = new i({
                        el: n
                    }), _ = new o({
                        hint: d,
                        input: n
...
var slider, map, infowindow = null,
...
function show() {
    var t, e;
    if (infowindow.close(), map.slide && 0 != locations.length) {
        if (1 == locations.length && (t = 0), locations.length > 1)
            do {
                t = Math.floor(Math.random() * locations.length)
            } while (t == current);
        current = t, setInfo(e = locations[t]), infowindow.open(map, e)
    }
}
...
function initialize() {
    ...
    var t = {
        ...
        e = document.getElementById("search-location"),
        n = new google.maps.places.Autocomplete(e);
    n.setComponentRestrictions({
        country: ["ch"]
    }), n.setFields(["address_components", "geometry", "icon", "name"]), google.maps.event.addListener(n, "place_changed", function() {
        var t = n.getPlace();
        t.geometry ? t.address_components && [t.address_components[0] && t.address_components[0].short_name || "", t.address_components[1] && t.address_components[1].short_name || "", t.address_components[2] && t.address_components[2].short_name || ""].join(" ") : window.alert("No details available for input: '" + t.name + "'")
    }), (map = new google.maps.Map(document.getElementById("map"), t)).slide = !0, setMarkers(map, locations), infowindow = new google.maps.InfoWindow({
        content: "loading..."
    }), google.maps.event.addListener(infowindow, "closeclick", function() {
        infowindow.close()
    }), slider = window.setTimeout(show, 3e3)
}

function setInfo(t) {
    var e = '<div class="profile-widget" style="width: 100%; display: inline-block;"><div class="doc-img"><a href="' + t.profile_link + '" tabindex="0" target="_blank"><img class="img-fluid " alt="' + t.doc_name + '" src="' + t.image + '"></a></div><div class="pro-content"><h3 class="title"><a href="' + t.profile_link + '" tabindex="0">' + t.doc_name + '</a><i class="fas fa-check-circle verified"></i></h3>';
    t.speciality && (e += '<p class="speciality">' + t.speciality + "</p>"), (t.address || t.next_available || t.amount) && (e += '<ul class="available-info"><li><i class="fas fa-map-marker-alt conveythis-no-translate "></i> ' + t.address + ' </li><li><i class="far fa-clock"></i> ' + t.next_available + '</li><li><i class="far fa-money-bill-alt"></i> ' + t.amount + "</li></ul>"), e += "</div></div>", infowindow.setContent(e)
}

function setMarkers(t, e) {
    for (var n = 0; n < e.length; n++) {
        var i = e[n],
            r = new google.maps.LatLng(i.lat, i.lng),
            s = new google.maps.Marker({
                ...
                next_available: i.next_available,
                amount: i.amount,
                profile_link: i.profile_link,
                total_review: i.total_review,
                animation: google.maps.Animation.DROP,
                icon: icons[i.icons],
                image: i.image
            });
        bounds.extend(s.position), e[n] = s, google.maps.event.addListener(s, "click", function() {
            setInfo(this), infowindow.open(t, this), window.clearTimeout(slider)
        })
    }
    t.fitBounds(bounds), google.maps.event.addListener(t, "zoom_changed", function() {})
}
google.maps.event.addDomListener(window, "load", initialize), $(document).ready(function() {
    var t, e;
    $.support.cors = !0, e = Handlebars.compile($("#result-template").html()), t = new Bloodhound({
        identify: function(t) {
            return t.id_str
        },
        ...
        dupDetector: function(t, e) {
            return t.id_str === e.id_str
        },
        prefetch: "https://www.docbooking.ch/search/prefetch",
        remote: {
            url: "https://www.docbooking.ch/search/find?q=%QUERY",
            wildcard: "%QUERY"
        }
    ...
    const t = Array.prototype.slice.call(arguments, 0, -1);

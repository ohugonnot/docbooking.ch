    ...
    public function __construct()
    {
        $apiContext = new ApiContext(
          new OAuthTokenCredential(
			  ...
			  'AbNEcnx9Nb-aLzBhDx3GxtudMQNHMnliObUauM171_AqPik0GiJGwU7BZpLkrB9YYm9mD-K5oCQ0rktx',
			  'ELVoVVqRf7gDyuI1YxrSFrMnvi6L_INAXUz1vBC5ih5SImzM7suYGSr7ijszGXVrA-et3RNwZtze4WX0'
          )
        );
